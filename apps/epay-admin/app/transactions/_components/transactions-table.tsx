...
import type { DataTableAdvancedFilterField, DataTableFilterField, DataTableRowAction } from '@/types/data-table';
...
export function TransactionsTable({ promises }: TransactionsTableProps) {
    ...
    const [, setRowAction] = React.useState<DataTableRowAction<Transaction> | null>(null);
